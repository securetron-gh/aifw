...
3. [M365 Copilot admin & agent sync](03-m365-copilot-bridge.mdx) - app-only Graph integration
4. [Agent self-enrollment (CSR + mTLS)](04-agent-self-enrollment.mdx) - the full enrollment round trip

Rendered: https://aifw.io/docs/tutorials/connect-openai-sdk
